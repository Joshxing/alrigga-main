    ...
    <div class="promotions">
        ...
        <div class="promotions-item">
            <div class="content-box">
                <img src="../assets/images/silog/burger.jpg" alt="">
            </div>
            ...
            <div class="description">
                ...
                <ul>
                    ...
                    <li>
                        <p>We accept COD and Credit card</p>
                    </li>
                </ul>
        ...
        <div class="promotions-item">
            <div class="content-box">
                <img src="../assets/images/ihaw-ihaw/isaw.jpg" alt="">
            </div>
        ...
        <div class="promotions-item">
            <div class="content-box">
                <img src="../assets/images/silog/sisig.jpg" alt="">
            </div>
