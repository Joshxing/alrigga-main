                                ...
                                <div v-for="(f, index) in filterFoods" :key="index">
                                    <div class="box-content row">
                                        ...
                                        <div class="item-price col-sm-1">
                                            <span class="sale-price">د.إ{{ parseFloat(f.food_price) -
                    ...
                    <div class="col-md-3">
                        <div class="box">
                            ...
                            <div class="box-content">
                                <span>Summary</span>
                                <h3 class="font-bold total-first-price">د.إ{{ calculateSummaryPrice()[0] }}</h3>

                                <span>Discount</span>
                                <h3 class="font-bold total-discount">د.إ{{ calculateSummaryPrice()[1] }}</h3>

                                <span>Delivery fee</span>
                                <h3 class="font-bold total-delivery">د.إ{{ calculateSummaryPrice()[2] }}</h3>

                                <hr />

                                <span>Total</span>
                                <h2 class="font-bold total-sale">د.إ{{ calculateSummaryPrice()[3] }}</h2>
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +971 52 766 9781</h3>
                                <span class="small">
